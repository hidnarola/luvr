...
<html lang="en">
    <head>
        ...
        <meta name="verify-admitad" content="d701ba592c" />
                        ...
                        <div class="header">
                            ...
                            <?php } else { ?>
                                <div class="header-r">
                                    ...
                                    <a href="https://api.instagram.com/oauth/authorize/?client_id=<?php echo INSTA_CLIENT_ID; ?>&redirect_uri=<?php echo base_url() . 'register/return_url'; ?>&response_type=code&scope=likes+comments+follower_list+relationships+public_content" class="login-instagram" style="text-transform:none;">
