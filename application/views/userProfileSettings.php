<div class="col-sm-12">
    ...
    <div class="form-group">
        ...
        echo form_input(array("name" => "age", "class" => "form-control", "type" => "number", "min" => "1"));
        ?>
    </div>
    <div class="form-group">
        <?php
        echo form_label('One Liner:', 'one_liner');
        echo form_input(array("name" => "one_liner", "class" => "form-control"));
        ?>
    </div>
    <div class="form-group">
        <?php
        echo form_label('Job|Work:', 'job');
        echo form_input(array("name" => "work", "class" => "form-control"));
        ?>
    </div>
    <div class="form-group">
        <?php
        echo form_label('Education:', 'school');
        echo form_input(array("name" => "school", "class" => "form-control"));
        ?>
    </div>
    <div class="form-group">
        <?php
        echo form_label('Location:', 'address');
        echo form_input(array("name" => "address", "class" => "form-control"));
        ?>
    </div>
    <div class="form-group">
        <?php
        echo form_label('About Me:', 'bio');
        echo form_textarea(array("name" => "bio", "class" => "form-control"));
        ?>
    </div>
    <?php
