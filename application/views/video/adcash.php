...
<video id="vid1" class="video-js vjs-default-skin" autoplay controls preload="auto" width="100%" height="768" poster="<?php echo S3_URL; ?>/Videos/Commercials/luvr-logo.jpg" data-setup="{}">
...
<script>
    ...
    vid1.ads();
    vid1.vast({
        url: '<?php echo S3_URL; ?>/assets/lib/sample-vast.xml'
    });
</script>