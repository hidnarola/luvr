...
<html lang="en">
  <head>
    ...
    <link href="<?php echo base_url('assets_socket/css/bootstrap.min.css');?>" rel="stylesheet">
  </head>
  <style>
  ...
  #load {
    ...
    font-size   : 0;
    opacity     : 0.6;
    background  : #E0E0E0  url(<?php echo base_url('assets_socket/images/load.gif');?>) center no-repeat;
  }
...
<center><a href="<?php echo site_url('socket/message');?>">Click here to see the list message</a></center><br />
<div class="container">
  <div class="row">
    <div id="notif"></div>
