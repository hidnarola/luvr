...
define('SK_TEST', 'sk_test_Bo5kCBime5Lej722tGp9yFpA');
define('PK_TEST', 'pk_test_uf8MkZddNEtqxSLVFApX3WtC');
define('SK_LIVE', 'sk_live_D7HN8AkaSNuBSO26uTvQnNYS');
define('PK_LIVE', 'pk_live_vXnAil5xwaYQmcDwdzvJ4N77');
